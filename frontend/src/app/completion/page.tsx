...
import { CheckCircle, Trophy, Star, BookOpen, Target, Download, Home } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg text-center">
                  <div className="text-2xl font-bold text-yellow-600">{overallStats.coursePassRate}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {Object.entries(quizResults).map(([weekKey, result]: [string, any]) => (
                  <div key={weekKey} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-3">
                {overallStats.averageScore >= 90 && (
                  <div className="flex items-center gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div>
                      <div className="font-medium text-yellow-800">Excellence Award</div>
                      <div className="text-sm text-yellow-700">90%+ average score</div>
                    </div>
                  </div>
                )}
                ...
                {overallStats.coursePassRate === 100 && (
                  <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div>
                      <div className="font-medium text-green-800">Perfect Completion</div>
                      <div className="text-sm text-green-700">Passed all quizzes</div>
                    </div>
                  </div>
                )}
                ...
                {overallStats.highestScore === 100 && (
                  <div className="flex items-center gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div>
                      <div className="font-medium text-blue-800">Perfect Score</div>
                      <div className="text-sm text-blue-700">100% on at least one quiz</div>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center gap-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-purple-800">Course Completion</div>
                    <div className="text-sm text-purple-700">Completed all {overallStats.totalQuizzes} weeks</div>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div className="mt-8 text-center space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Thank you for choosing our adaptive learning platform. Keep learning and growing! 🚀
          </p>
        </div>
